...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblSbase.setText(_translate("MainWindow", "S_base (MVA)"))
        self.lblVbase.setText(_translate("MainWindow", "V_base (kV)"))
        self.lblCondName.setText(_translate("MainWindow", "ACSR Conductor Name"))
        self.lblPhase.setText(_translate("MainWindow", "Phase"))
        self.lblB1.setText(_translate("MainWindow", "B1"))
        self.lblC1.setText(_translate("MainWindow", "C1"))
        self.lblA1.setText(_translate("MainWindow", "A1"))
        self.lblB2.setText(_translate("MainWindow", "B2"))
        self.lblA2.setText(_translate("MainWindow", "A2"))
